...
export const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-purple-800 via-blue-800 to-purple-900 text-white pt-12 pb-6 relative">
      {/* Wave divider for visual interest */}
      <div className="absolute top-0 left-0 right-0 h-12 overflow-hidden">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="absolute bottom-0 w-full h-12 text-white/10 fill-current">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="absolute -top-5 left-1/2 transform -translate-x-1/2">
          <button 
            onClick={scrollToTop}
            className="bg-white/90 text-purple-700 p-3 rounded-full shadow-lg hover:bg-white transition-colors focus:outline-none focus:ring-2 focus:ring-white/50 focus:ring-offset-2 focus:ring-offset-purple-800 relative overflow-hidden group"
            aria-label="Skrolla till toppen"
          >
            <span className="absolute inset-0 bg-purple-600/20 transform -translate-y-full group-hover:translate-y-0 transition-transform duration-300"></span>
        ...
        <div className="flex flex-col md:flex-row justify-between mb-10">
          ...
          <div className="mb-8 md:mb-0 md:w-1/3">
            ...
            <div className="flex flex-col space-y-2">
              <div className="flex items-center text-white/70 text-sm group">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:w-2/3">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#animated-background" className="text-white/70 hover:text-white transition-colors flex items-center group">
                    <span className="w-1.5 h-1.5 bg-white rounded-full mr-2 inline-block transform transition-transform group-hover:scale-125"></span> 
                    Animerad bakgrund
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white/70 hover:text-white transition-colors flex items-center group">
                    <span className="w-1.5 h-1.5 bg-white rounded-full mr-2 inline-block transform transition-transformation group-hover:scale-125"></span> 
                    Mellanöstern
                  </a>
                </li>
                <li>
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <div className="mt-6 bg-white/10 backdrop-blur-sm p-4 rounded-lg transform transition-all hover:scale-102 hover:shadow-md border border-white/20">
                ...
                {submitStatus === 'success' ? (
                  ...
                  <form onSubmit={handleSubmit} className="flex">
                    <input 
                      ...
                      className="w-full bg-white/20 border-0 rounded-l-lg p-2 text-sm text-white focus:outline-none focus:ring-1 focus:ring-white/50 placeholder-white/60 backdrop-blur-sm"
                      aria-label="Din e-postadress för nyhetsbrev"
                    />
                    <button 
                      type="submit"
                      className="bg-white/90 text-purple-700 text-sm py-2 px-3 rounded-r-lg hover:bg-white transition-colors"
