  ...
  return (
    <footer className="bg-black text-white pt-12 pb-6 relative">
      ...
      <div className="absolute top-0 left-0 right-0 h-12 overflow-hidden">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="absolute bottom-0 w-full h-12 text-purple-100 fill-current">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-purple-500 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center text-gray-300 text-sm">
            ...
            <Heart size={14} className="mx-1 text-purple-300 animate-pulse" />
