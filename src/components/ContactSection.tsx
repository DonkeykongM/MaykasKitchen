...
export const ContactSection = () => {
  ...
  return (
    <section id="kontakt" className="py-16 relative">
      {/* Decorative elements */}
      <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full opacity-20 transform translate-x-1/3 -translate-y-1/3 z-0"></div>
      <div className="absolute bottom-0 left-0 w-48 h-48 bg-white/10 rounded-full opacity-20 transform -translate-x-1/3 translate-y-1/3 z-0"></div>
      
      <div className="container mx-auto px-4 relative z-10">
        <span className="block text-center text-white/90 text-sm font-medium mb-2 uppercase tracking-wider">Nå mig</span>
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-white">Kontakta mig</h2>
        <p className="text-center mb-12 max-w-2xl mx-auto text-white/85">Hör gärna av dig för samarbeten, frågor eller bara för att säga hej!</p>
        
        <div className="flex flex-col md:flex-row gap-8">
          <div className="md:w-1/2">
            <div className="bg-white/95 backdrop-blur-sm p-8 rounded-lg shadow-md border border-white/20" ref={formRef}>
              ...
              {formStatus === 'success' ? (
                ...
                <form onSubmit={handleSubmit} noValidate>
                  <div className="mb-4">
                    <label htmlFor="name" className="block text-purple-800 mb-2 font-medium">Namn <span className="text-red-500">*</span></label>
                    <input 
                      type="text" 
                      id="name"
                      name="name"
                      ...
                      className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all ${
                        fieldErrors.name ? 'border-red-500 bg-red-50' : 'border-purple-300'
                      }`}
                  ...
                  <div className="mb-4">
                    <label htmlFor="email" className="block text-purple-800 mb-2 font-medium">E-post <span className="text-red-500">*</span></label>
                    <input 
                      type="email" 
                      id="email" 
                      name="email"
                      ...
                      className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all ${
                        fieldErrors.email ? 'border-red-500 bg-red-50' : 'border-purple-300'
                      }`}
                  ...
                  <div className="mb-4">
                    <label htmlFor="subject" className="block text-purple-800 mb-2 font-medium">Ämne</label>
                    <input 
                      type="text" 
                      id="subject" 
                      name="subject"
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all border-purple-300"
                      placeholder="Vad handlar ditt meddelande om?"
                    />
                  </div>
                  <div className="mb-6">
                    <label htmlFor="message" className="block text-purple-800 mb-2 font-medium">Meddelande <span className="text-red-500">*</span></label>
                    <textarea 
                      id="message" 
                      name="message"
                      ...
                      className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all ${
                        fieldErrors.message ? 'border-red-500 bg-red-50' : 'border-purple-300'
                      }`}
                  ...
                  <div className="mb-6">
                    <label className="flex items-center">
                      ...
                      />
                      <span className="ml-2 text-sm text-purple-700">Jag vill prenumerera på nyhetsbrevet och få de senaste recepten direkt i min inkorg.</span>
                    </label>
                  </div>
                  ...
                  <button 
                    ...
                    className="w-full bg-purple-600 text-white py-3 rounded-lg hover:bg-purple-700 transition duration-300 flex items-center justify-center disabled:opacity-70 font-semibold"
                  >
          ...
          <div className="md:w-1/2">
            <div className="bg-white/95 backdrop-blur-sm p-8 rounded-lg shadow-md mb-8 border border-white/20">
              <h3 className="text-xl font-semibold mb-6 flex items-center text-purple-800">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-purple-800">E-post</h4>
                    <a href="mailto:info@maykaskitchen.se" className="text-purple-600 hover:text-purple-800 transition-colors">info@maykaskitchen.se</a>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-purple-100 p-3 rounded-full mr-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-purple-800">Plats</h4>
                    <p className="text-purple-600">Skåne, Sverige</p>
                    <p className="text-xs text-purple-500 mt-1">Tillgänglig för uppdrag i hela Sverige</p>
                  </div>
                </div>
              </div>
            </div>
            
            <div className="bg-white/95 backdrop-blur-sm p-8 rounded-lg shadow-md border border-white/20">
              <h3 className="text-xl font-semibold mb-6 flex items-center text-purple-800">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div>
                    <h4 className="font-semibold text-purple-800">Instagram</h4>
                ...
                >
                  ...
                  <div>
                    <h4 className="font-semibold text-purple-800">TikTok</h4>
                ...
                >
                  ...
                  <div>
                    <h4 className="font-semibold text-purple-800">YouTube</h4>
                ...
                >
                  ...
                  <div>
                    <h4 className="font-semibold text-purple-800">Facebook</h4>
              ...
              <div className="mt-6 bg-gradient-to-r from-purple-500 to-blue-500 text-white p-4 rounded-lg">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center text-white hover:text-yellow-200 font-medium"
                >
