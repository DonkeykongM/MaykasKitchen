...
export const Header = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 w-full max-w-7xl">
        <div className="flex justify-between items-center w-full">
          ...
          >
            ...
            <span className="text-lg md:text-2xl font-bold text-purple-600 tracking-tight truncate transition-colors group-hover:text-purple-700 font-serif">
              MaykasKitchen
            </span>
          </a>
      ...
      {/* Search Panel */}
      <div 
        className={`bg-white border-t border-purple-100 shadow-lg py-4 transform transition-all duration-300 ease-in-out ${
          isSearchOpen 
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <form onSubmit={handleSearchSubmit} className="relative">
            ...
            <input
              ...
              className="w-full px-4 py-3 pl-12 border border-purple-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-purple-600 pr-10 text-base"
              value={searchTerm}
            ...
            <div className="flex flex-wrap gap-2">
              {popularSearches.map((search) => (
                <button 
                  ...
                  className="text-xs bg-purple-50 text-purple-700 px-3 py-1 rounded-full hover:bg-purple-600 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-1"
                  type="button"
                >
                  {search}
                </button>
